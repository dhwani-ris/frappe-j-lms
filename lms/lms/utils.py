...
def get_batch_students(
    ...
    # Apply employee permission filtering based on hierarchy
    ...
    if user == "Administrator" or "System Manager" in roles:
        ...
        if employee:
            ...
            if reporting_employees:
                # User has reports, show their enrollments + own
                ...
                # No reports, show only own enrollments
                enrollment_filters["member"] = user
        else:
            # Not an employee, show only own enrollments
            enrollment_filters["member"] = user
    ...
    students_list = frappe.get_all(
        ...
        fields=["member", "name", "approval_status", "approved_by", "approval_date", "employee", "employee_name", "manager_comments"],
        start=start,
    ...
    for student in students_list:
        ...
        # Add approval fields to details
        details["approval_status"] = student.get("approval_status") or "Pending"
        details["approved_by"] = student.get("approved_by")
        details["approval_date"] = student.get("approval_date")
        details["employee"] = student.get("employee")
        details["employee_name"] = student.get("employee_name")
        details["manager_comments"] = student.get("manager_comments")
